...
//changes: using typedef struct instead of struct from A3 for both dep and emp
typedef struct Dept 
{
	long int managerId;
    long int did;
...
int LogNum = 0;
const bool TEST_CRASH = true;  //set to false if dont want to do crash testing
